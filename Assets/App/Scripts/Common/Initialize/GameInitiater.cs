    ...
    public class GameInitiater : MonoBehaviour
    {
        ...
        private void InitializeWithDependencies()
        {
            ...
            foreach (var component in sortedComponents)
            {
                try
                {
                    component.Initialize(referenceHolder);
                    referenceHolder.RegisterInitializable(component);
                    if (enableDetailedLogging)
                    {
        ...
        private void InitializeSimple()
        {
            ...
            foreach (var obj in InitializeObjects)
            {
                ...
                foreach (var initializer in initializers)
                {
                    try
                    {
                        initializer.Initialize(referenceHolder);
                        referenceHolder.RegisterInitializable(initializer);
        ...
        {
            referenceHolder.ClearReferences();
        }
    }
}
